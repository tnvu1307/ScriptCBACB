SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE ba0010(
...
BEGIN
    ...
    INTO  V_OFFICE,V_PHONE,V_BUSSINESSID
    FROM SYSVAR
    WHERE GRNAME ='SYSTEM'
    AND VARNAME IN ('HEADOFFICE','PHONE','BUSSINESSID');
    --BANKACCTNO
...
EXCEPTION
  WHEN OTHERS
   THEN
      PLOG.ERROR ('BA0010: ' || SQLERRM || DBMS_UTILITY.FORMAT_ERROR_BACKTRACE);
      RETURN;
END;
/
