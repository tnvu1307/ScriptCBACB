SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE se00446 (
 ...
 FOR
       ...
       SUM(CAS.QTTY + cas.cutqtty + cas.sendqtty)  QTTY,
        ...
        WHERE CF.CUSTODYCD = V_CUSTODYCD AND CF.CUSTID = AF.CUSTID
                ...
                AND CA.CATYPE='017' AND AF.ACCTNO LIKE V_STRAFACCTNO
...
EXCEPTION
   WHEN OTHERS
   THEN
   plog.error('SE00446: Error: ' || SQLERRM || dbms_utility.format_error_backtrace);
      RETURN;
END;
