SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE OD6017 (
    ...
    OPEN PV_REFCURSOR FOR
        ...
        FROM (
                ...
                FROM (
                  ...
                  JOIN DDMAST DD1 ON DD1.ACCTNO = TL.DDACCTNO AND DD1.CCYCD ='VND' 
                  JOIN DDMAST DD2 ON DD2.ACCTNO = TL.DDACCTNO1 AND DD2.CCYCD ='USD'
...
EXCEPTION
  WHEN OTHERS
   THEN
   DBMS_OUTPUT.PUT_LINE('OD6017 ERROR');
   PLOG.ERROR('OD6017: - ' ||DBMS_UTILITY.FORMAT_ERROR_BACKTRACE);
      RETURN;
END;
/
