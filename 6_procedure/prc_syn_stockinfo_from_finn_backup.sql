SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE "PRC_SYN_STOCKINFO_FROM_FINN_BACKUP"
IS
    pkgctx   plog.log_ctx;
...
*/
    ...
    (
        ...
        SELECT  ORGANCODE,ISINCODE,TICKER SYMBOL, 10000 parvalue,
               ...
               -- TP
               null EXPDATE, '000' BONDTYPE, '' TYPETERM, '' TERM, 0 INTCOUPON ,0 IssuePrice, 0 TermStageCode, 0 ShareIssue,'' bondname
        ...
        SELECT organcode, bondisincode ISINCODE, bondcode SYMBOL, parvalue,
                CASE WHEN UPPER(comgroupcode)='VNINDEX' THEN '001'
                     WHEN UPPER(comgroupcode)='HNXINDEX' THEN '002'
                     WHEN UPPER(comgroupcode)='BOND' THEN '010'
        ...
        UNION ALL -- cw
        SELECT issuerorgancode organcode, '' ISINCODE, TICKER SYMBOL, 10000 parvalue,
               ...
               0 legalcaptial, 0 sharecapital,
               organcode underlyingsymbol, issuerorgancode issuername,
               ...
               null EXPDATE, '000' BONDTYPE, '' TYPETERM, '' TERM, 0 INTCOUPON, IssuePrice, to_number(REPLACE(replace(TermStageCode,'M'),'.',',')),  ShareIssue ,'' bondname
    ...
    loop
       ...
       begin
        ...
        If REC.SECTYPE <> '011' then --011: CW
