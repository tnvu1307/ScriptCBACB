...
begin
    ...
    if TellerId='0001' THEN --Admin he thong
        ...
        FROM (select * from tllog where batchname = ''DAY'' or tltxcd in (''0381'',''3375'')) lg0, ALLCODE A0, ALLCODE A1,tltx,SBSECURITIES SB, cfmast cf,
          (
        ...
        SELECT distinct * FROM (SELECT lg0.CFFULLNAME CFFULLNAME, lg0.CFCUSTODYCD IDAFACCTNO, cf.cifid, NVL(SB.SYMBOL,''---'') CODEID,
            ...
            FROM (select * from tllog where batchname = ''DAY'' or tltxcd in (''0381'',''3375'')) lg0, cfmast cf,
