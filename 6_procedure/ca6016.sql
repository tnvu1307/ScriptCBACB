SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE ca6016 (
...
IS
    -- GIAY TONG HOP ÐANG KY CHUYEN ÐOI TRAI PHIEU CHUYEN ÐOI (MAU 33A-THQ)
...
EXCEPTION
  WHEN OTHERS
   THEN
      PLOG.ERROR ('CA6016: ' || SQLERRM || DBMS_UTILITY.FORMAT_ERROR_BACKTRACE);
      RETURN;
END;
/
