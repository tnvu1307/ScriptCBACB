SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE cf6037 (
...
OPEN PV_REFCURSOR FOR
    ...
    select cf.custodycd, --so tk luu ky
        ...
        to_char(to_date(doc.opndate,'dd/mm/rrrr'),'dd Mon rrrr') opndate, --ngay nhap kho chung chi
...
EXCEPTION
  WHEN OTHERS
   THEN
      plog.error ('CF6037: ' || SQLERRM || dbms_utility.format_error_backtrace);
      Return;
End;
/
