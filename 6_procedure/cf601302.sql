SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE cf601302 (
...
OPEN PV_REFCURSOR FOR
    SELECT   FULLNAME AS AMC_FULLNAME
            ,TRADINGCODE AS AMC_TRADINGCODE
    FROM CFMAST
    WHERE AMCID= V_AMCID
    AND STATUS <> 'C'
...
EXCEPTION
  WHEN OTHERS
   THEN
      PLOG.ERROR ('CF601302: ' || SQLERRM || DBMS_UTILITY.FORMAT_ERROR_BACKTRACE);
      RETURN;
END;
/
