SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE cf601102(
    ...
    WITH TMPINDAY AS(
        ...
        SELECT CF.CUSTODYCD,
               ...
               CASE WHEN CF.CUSTATCOM='Y' THEN V_HEADOFFICE ELSE LCB.FULLNAME END CFBANKNAME,
                ...
                SB.EN_EXCHANGES,
                SB.LISTINGQTTY,
                (CASE WHEN CF.CUSTATCOM = 'Y' THEN SE.TRADE + (CASE WHEN SB.SYMBOL LIKE '%_WFT' THEN 0 ELSE SE.RECEIVING END) + SE.MORTAGE + SE.BLOCKED + SE.EMKQTTY - NVL(INDAY.NAMT,0) ELSE SE.TRADE END) ENDQTTY
        FROM (
...
EXCEPTION
  WHEN OTHERS
   THEN
      PLOG.ERROR ('CF601102: ' || SQLERRM || DBMS_UTILITY.FORMAT_ERROR_BACKTRACE);
      RETURN;
END;
/
