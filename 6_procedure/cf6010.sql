SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE cf6010(
...
BEGIN
  SELECT (CASE WHEN SUM(SI.LISTINGQTTY) <> 0 THEN ROUND(100*(SUM(SE.ENDQTTY))/(SUM(SI.LISTINGQTTY)),2) ELSE 0 END) V_PERCENT_RELATED, NVL(SUM(SE.ENDQTTY),0) V_QTTY_RELATED
        ...
        (
            ...
            (
                SELECT SB.CODEID, SB.SYMBOL, (CASE WHEN SB.REFCODEID IS NULL THEN SB.TRADEPLACE ELSE SB1.TRADEPLACE END) TRADEPLACE,
        ...
        (
                ...
                (
                        ...
                        NVL(SUM(CASE WHEN P_SHARESOUTTYP='O' AND HISTDATE=V_PREVDATE THEN OLDCIRCULATINGQTTY
...
OPEN PV_REFCURSOR FOR
    ...
    (
        SELECT CF.CUSTODYCD, CF.FULLNAME, CF.CIFID,CF.TRADINGCODE,
               ...
               NVL(SE.BEGINQTTY - SE.ENDQTTY, 0) INDAYQTTY,
...
EXCEPTION
  WHEN OTHERS
   THEN
      PLOG.ERROR ('CF6010: ' || SQLERRM || DBMS_UTILITY.FORMAT_ERROR_BACKTRACE);
      RETURN;
END;
/
