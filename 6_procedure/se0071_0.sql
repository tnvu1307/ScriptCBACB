SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE se0071_0 (
...
-- GET REPORT'S DATA
 OPEN PV_REFCURSOR
 FOR
SELECT v_BRNAME TVLK,FULLNAME, CUSTODYCD, ACCTNO,SYMBOL, IDCODE, IDDATE,IDPLACE, ADDRESS,MOBILE,
...
GROUP BY FULLNAME, CUSTODYCD, ACCTNO,SYMBOL, IDCODE, IDDATE,IDPLACE, ADDRESS,MOBILE,
