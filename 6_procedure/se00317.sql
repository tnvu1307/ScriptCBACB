...
SELECT distinct CUSTODYCD,DT.SYMBOL,REPORTDATE,CA_TYLE,REPORT_QTTY,CUTPBALANCE,ROUND(REPORT_QTTY * RATE ) QTTY,CUTAQTTY,
        ...
        FROM (
            ...
            '005',CA.DEVIDENTSHARES,'010', CA.DEVIDENTRATE||'%','022',CA.DEVIDENTSHARES, '1/1')) CA_TYLE,
...
EXCEPTION
  WHEN OTHERS
   THEN
   DBMS_OUTPUT.PUT_LINE('SE00317 ERROR');
   PLOG.ERROR('SE00317: - ' ||DBMS_UTILITY.FORMAT_ERROR_BACKTRACE);
      RETURN;
END;
/
