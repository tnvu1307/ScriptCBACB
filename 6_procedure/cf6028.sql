SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE cf6028 (
...
OPEN PV_REFCURSOR FOR
    Select fa.fullname,
           ...
           v_FAX FAX
    from famembers fa
    where roles = 'BRK' and fa.valdate is not null and fa.shortname like P_BRKID;

EXCEPTION
  WHEN OTHERS
   THEN
      plog.error ('cf6028: ' || SQLERRM || dbms_utility.format_error_backtrace);
      Return;
End;
/
