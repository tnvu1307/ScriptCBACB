...
(SELECT VSDID FROM CAMAST WHERE CAMASTID = ''<$FILTERID>'') VID
WHERE LOG.VSDID = VID.VSDID
    AND ROWNUM <=1', 'Mã báo cáo', 'Report id', 'C', 'N', 1);Insert into VSDTXMAPEXT   (OBJTYPE, OBJNAME, TRFCODE, FLDNAME, FLDTYPE, AMTEXP, CMDSQL, CAPTION, EN_CAPTION, CHSTATUS, SPLIT, ODRNUM) Values   ('T', '3335', '598.005.CAINFO', 'TRANDATE', 'D', '<$BUSDATE>', '', 'Ngày giao dịch', 'Transaction Date', 'C', 'N', 3);Insert into VSDTXMAPEXT   (OBJTYPE, OBJNAME, TRFCODE, FLDNAME, FLDTYPE, AMTEXP, CMDSQL, CAPTION, EN_CAPTION, CHSTATUS, SPLIT, ODRNUM) Values   ('T', '3335', '598.005.CAINFO', 'TRANNUM', 'C', '$07', '', 'Mã đợt thực hiện quyền', 'Corporate action code', 'C', 'N', 2);Insert into VSDTXMAPEXT   (OBJTYPE, OBJNAME, TRFCODE, FLDNAME, FLDTYPE, AMTEXP, CMDSQL, CAPTION, EN_CAPTION, CHSTATUS, SPLIT, ODRNUM) Values   ('T', '3335', '598.005.CAINFO', 'TXDATE', 'D', '<$BUSDATE>', '', 'Ngày tạo yêu cầu', 'Preparation Date', 'C', 'N', 16);Insert into VSDTXMAPEXT   (OBJTYPE, OBJNAME, TRFCODE, FLDNAME, FLDTYPE, AMTEXP, CMDSQL, CAPTION, EN_CAPTION, CHSTATUS, SPLIT, ODRNUM) Values   ('T', '3335', '598.005.CAINFO', 'CONFIRMSTATUS', 'C', '$15', '', 'Trạng thái xác nhận', 'Comfirmation status', 'C', 'N', 5);Insert into VSDTXMAPEXT   (OBJTYPE, OBJNAME, TRFCODE, FLDNAME, FLDTYPE, AMTEXP, CMDSQL, CAPTION, EN_CAPTION, CHSTATUS, SPLIT, ODRNUM) Values   ('T', '3335', '598.005.CAINFO', 'DESC', 'C', '$30', '', 'Diễn giải', 'Description', 'C', 'N', 10);COMMIT;