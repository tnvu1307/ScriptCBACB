SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2314','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('SE2314', 'Tra cứu các tài khoản đã gửi hồ sơ chuyển khoản lên VSD để hoàn tất (TPRL)(2314)', 'Look up accounts that have sent transfer documents to VSD to complete (PPBs)(2314)', 'SELECT SED.AUTOID, SED.TXDATE, SED.QTTY, SED.ACCTNO, SED.AFACCTNO, SED.QTTYTYPE, SED.REFERENCEID, SED.RECCUSTODYCD, SED.RECMEMBER, SED.YBEN,
    SB.CODEID, SB.SYMBOL,
...
)', 'SE2314', 'frmSE2314', 'AUTOID DESC', '2314', 0, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;