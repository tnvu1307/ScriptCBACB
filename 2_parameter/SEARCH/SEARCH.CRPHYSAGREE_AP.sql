SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CRPHYSAGREE_AP','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CRPHYSAGREE_AP', 'Quản lý thông tin hợp đồng ', 'Manage physical subscription agreement ', 'SELECT CR.*, (CR.QTTY-CR.REQTTY) TREMQTTY, 0 CHECKVAL
...
AND CR.STATUS = ''A''', 'CRPHYSAGREE_AP', NULL, 'CRPHYSAGREEID DESC', NULL, 0, 5000, 'N', 1, NULL, 'Y', 'T', NULL, 'N', NULL);COMMIT;