...
AND A.REFCONFIRMNUMBER=C.REFCONFIRMNUMBER AND OD.CODEID=SEC.CODEID AND C.DELTD<>''Y'' AND SEC.TRADEPLACE=''002''', 'OD.ODMAST', NULL, NULL, '8813', 10, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;