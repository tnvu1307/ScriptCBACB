SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CA1007','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CA1007', 'Danh sách người sở hữu chứng khoán được phân bổ quyền mua(đối chiếu)', 'List of securities owners with the right to buy (compare)', 'SELECT *
FROM
(
    SELECT MCF.CUSTODYCD, CAS.CAMASTID,
        ...
        SUM(CAS.BALANCE) BALANCE, SUM(CAS.QTTY) QTTY, SUM(CAS.AMT) AMT, SUM(CAS.AQTTY) AQTTY, SUM(CAS.AAMT) AAMT, SUM(CAS.TRADE) TRADE,
        SUM(CAS.PBALANCE + CAS.BALANCE - CAS.INBALANCE + CAS.OUTBALANCE) PBALANCE,
...
) WHERE 0=0', 'CASCHD', 'frmCASCHD', '', '', NULL, 5000, 'N', 1, 'NYNNYYYNNY', 'Y', 'T', '', 'N', '');COMMIT;