...
WHERE DF.AFACCTNO = AF.ACCTNO
    ...
    AND LNS.NML+LNS.OVD+LNS.INTNMLACR+LNS.INTDUE+LNS.INTOVD+LNS.INTOVDPRIN+LNS.FEEINTNMLACR+LNS.FEEINTDUE+LNS.FEEINTNMLOVD+LNS.FEEINTOVDACR>1', 'DFGROUP', NULL, ' CUSTODYCD, AFACCTNO, GROUPID, LNSCHDID ', '2690', NULL, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;