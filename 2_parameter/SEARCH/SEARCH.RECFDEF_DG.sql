SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('RECFDEF_DG','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('RECFDEF_DG', 'Loại hình đại lý/môi giới', 'Broker/Remiser product', '
SELECT (CF.CUSTID||''.''||RF.REACTYPE) REACCT, RF.AUTOID, CFMAST.FULLNAME, TYP.ACTYPE, TYP.TYPENAME, A2.CDCONTENT AFSTATUS,
...
AND TYP.REROLE=''DG'' and nvl(RF.status,''A'')=''A'' and cf.status=''A''
', 'RE.RECFDEF_01', 'frmRECFDEF_01', 'ACTYPE,TYPENAME,FULLNAME', NULL, 0, 5000, 'N', 1, NULL, 'Y', 'T', NULL, 'N', NULL);COMMIT;