...
AND CF.CUSTID =AF.CUSTID AND NVL(TBL.DELTD,''0'') <>''Y''  AND TBL.AUTOID NOT IN (SELECT REFKEY FROM TLLOGEXT WHERE TLTXCD=''1101'' AND DELTD=''N'' AND STATUS IN (''0'',''1'', ''3'',''4'') ) ', 'CIMAST', 'frmCIMAST', NULL, '1101', NULL, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;