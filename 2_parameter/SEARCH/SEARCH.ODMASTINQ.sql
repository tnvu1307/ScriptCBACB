...
ELSE OD.ORSTATUS END) = A1.CDVAL and (CF.CAREBY IN (SELECT TLGRP.GRPID FROM TLGRPUSERS TLGRP WHERE TLID = ''<$TELLERID>'') OR ''0001''=''<$TELLERID>'')', 'OD.ODMAST', 'frmODMAST', 'ORDERID DESC', '', NULL, 5000, 'N', 1, '', 'Y', 'T', '', 'N', '');COMMIT;