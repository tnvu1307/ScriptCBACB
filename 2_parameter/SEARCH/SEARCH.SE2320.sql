SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2320','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('SE2320', 'Tra cứu các tài khoản đã gửi hồ sơ cầm cố lên VSD để hủy (TPRL)(2320)', 'Look up accounts that have sent blockade documents to VSD for cancellation (PPBs)(2320)', 'SELECT SED.AUTOID, SED.TXDATE, SED.QTTY, SED.ACCTNO, SED.AFACCTNO, SED.QTTYTYPE, SED.PLACEID, SED.CONTRACTNO, SED.CONTRACTDATE,
    SB.CODEID, SB.SYMBOL,
...
)', 'SE2320', 'frmSE2320', 'AUTOID DESC', '2320', 0, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;