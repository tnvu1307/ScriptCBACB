SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('MR0111','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('MR0111', 'Theo dõi Hold thêm tiền các khoản T3  đến hạn(6690)', 'Holdbalance for T3 due account (6690)', 'select af.brid, cf.custodycd,af.acctno AFACCTNO,cf.fullname, aft.mnemonic,
    ci.balance,CI.odamt, ci.dueamt,ci.depofeeamt,trfbuyamt, nvl(b.execbuyamt,0) execbuyamt,
    ci.bankavlbal,
    ci.dueamt + ci.depofeeamt - ci.balance ADDBALANCE,
    least (ci.dueamt + ci.depofeeamt - ci.balance, ci.bankavlbal) bankholdamt
       ...
       and CI.dueamt - ci.balance>1', 'MRTYPE', NULL, NULL, '6690', 0, 5000, 'N', 1, 'NYNNYYYYYN', 'Y', 'T', NULL, 'Y', 'AFACCTNO');COMMIT;