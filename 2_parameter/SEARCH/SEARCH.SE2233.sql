SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2233','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('SE2233', 'Yêu cầu giải tỏa cầm cố chứng khoán(2233)', 'Yêu cầu giải tỏa cầm cố chứng khoán (2233)', 'SELECT MT.AUTOID, SE.AFACCTNO AFACCTNO, SE.ACCTNO ACCTNO, CF.FULLNAME CUSTNAME, CF.CUSTODYCD, SB.SYMBOL,
...
(SELECT REFID, SUM(QTTY) QTTY FROM SEMORTAGE WHERE TLTXCD = ''2233'' AND DELTD = ''N'' AND REFID IS NOT NULL GROUP BY REFID) RL
...
AND MT.QTTY - NVL(RL.QTTY,0) > 0 AND SE.MORTAGE > 0
AND MT.ISSUESID = I1.AUTOID(+)', 'SEMAST', NULL, NULL, '2233', 0, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;