SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CLIENTBROKERHIST','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CLIENTBROKERHIST', 'Đối chiếu lịch sử nguồn Client và Broker', 'Reconcile history source Client and Broker', 'SELECT VW.NOTE1, VW.NOTE, VW.ISODMAST, VW.CUSTMEMBER, VW.CMPMEMBER, VW.VSDMEMBER, A.<@CDCONTENT> SUPERBANK, CF.CUSTODYCD, VW.SYMBOL, SB.ASSETTYPE, VW.TRANSTYPE, VW.TRADEDATE, VW.TRADEDATECTCK, VW.TRADEDATEVSD, VW.CUSTSETTLEDATE, VW.CMPSETTLEDATE, VW.VSDSETTLEDATE,
...
FROM V_COMPARE_CLIENTBROKERHIST VW,
...
ORDER BY VW.CMPMEMBER, VW.NOTE1', 'CLIENTBROKERHIST', NULL, 'TXTIME desc', NULL, 0, 500, 'N', 30, 'NNNNYYYNNN', 'N', 'T', NULL, 'N', NULL);COMMIT;