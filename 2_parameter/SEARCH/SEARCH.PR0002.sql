SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('PR0002','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('PR0002', 'Tra cứu Room CK margin (theo UBCK)', 'Margin room Master', 'SELECT ROWNUM NO, CODEID, SYMBOL, LISTINGQTTY, ROOMLIMITMAX, ROOMLIMIT, ROOMUSED, ROOMREMAIN,
...
FROM (SELECT  SB.CODEID, SB.SYMBOL, SB.LISTINGQTTY, (SB.LISTINGQTTY*SYSR1.VARVALUE/100) ROOMLIMITMAX, RM.ROOMLIMIT ROOMLIMIT, RM.ROOMUSED, RM.ROOMREMAIN,
        ...
        ORDER BY SB.SYMBOL)
        WHERE 0=0 ', 'SYSMRROOM', NULL, NULL, '0104', NULL, 5000, 'N', 1, NULL, 'Y', 'T', NULL, 'N', NULL);COMMIT;