SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('FAACCTMAIN','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('FAACCTMAIN', 'Gán biểu phí cho Fund', 'Add fee scheme for Fund', 'SELECT CF.AUTOID,CFM.CIFID, CF.CUSTODYCD,CFM.FULLNAME, FE.REFCODE, FE.SUBTYPE, CF.EFFDATE, CF.EXPDATE, CF.FEEVAL
