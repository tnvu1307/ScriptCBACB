...
AND a5.CDTYPE = ''SY'' AND a5.CDNAME = ''YESNO'' AND TRIM(a5.CDVAL) = NVL((SELECT ''Y'' FROM rptmaster_fee fee WHERE fee.rptid = rpt.rptid), ''N'')', 'RPTMASTER', 'frmRPTMASTER', NULL, NULL, NULL, 5000, 'N', 1, NULL, 'Y', 'T', NULL, 'N', NULL);COMMIT;