SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2246','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('SE2246', 'Tra cứu các tài khoản đang chờ duyệt từ trung tâm lưu ký (2246)', 'View pending to approve from depository center (2246)', 'SELECT DISTINCT FN_GET_LOCATION(CFMAST.BRID) LOCATION, SEDEPOSIT.Senddepodate TXDATE, to_char(SEDEPOSIT.Senddepodate,''YYYY/MM/DD'') TXDATE1,
A4.<@CDCONTENT> TRADEPLACE, SEMAST.ACTYPE,
                ...
                NVL(CI.DEPOLASTDT, getcurrdate) DEPOLASTDT,SEDEPOSIT.VSDCODE,CFMAST.MCUSTODYCD
 ...
 WHERE SEMAST.SENDDEPOSIT > 0
   ...
   AND SEDEPOSIT.ACCTNO = SEMAST.ACCTNO', 'SEMAST', NULL, 'TXDATE', '2246', 0, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;