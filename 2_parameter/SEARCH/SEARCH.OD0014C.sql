SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('OD0014C','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('OD0014C', 'Nhận tiền bán', 'Receive money for sale', 'SELECT MST.AUTOID, MST.ORDERID, MST.AFACCTNO, MST.AFACCTNO || MST.CODEID SEACCTNO, MST.CODEID, MST.QTTY, MST.AMT, MST.FEEAMT,MST.CLEARDATE SETTLEMENT,FA.SHORTNAME BROKER, MST.VAT TAXAMT, --STS.NETTING QTTY, STS.CASHRECEVING AMT, STS.FEEAMT, STS.VAT TAXAMT, STS.CLEARDATE SETTLEMENT,
