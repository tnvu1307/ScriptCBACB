SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2315','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('SE2315', 'Tra cứu các tài khoản đã gửi hồ sơ chuyển khoản lên VSD để hủy (TPRL)(2315)', 'Look up accounts that have sent transfer documents to VSD for cancellation (PPBs)(2315)', 'SELECT SED.AUTOID, SED.TXDATE, SED.QTTY, SED.ACCTNO, SED.AFACCTNO, SED.QTTYTYPE, SED.REFERENCEID, SED.RECCUSTODYCD, SED.RECMEMBER, SED.YBEN,
    SB.CODEID, SB.SYMBOL,
...
)', 'SE2315', 'frmSE2315', 'AUTOID DESC', '2315', 0, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;