SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CAMAST_3310','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CAMAST_3310', 'Quản lý thực hiện quyền', 'Coporate action management', 'SELECT VALUE, AUTOID, SYMBOL, CAMASTID, CODEID, EXCODEID, TYPEID, A1.<@CDCONTENT> CATYPE, KHQDATE,
...
AND CA.STATUS = ''V''
AND CA.CATYPE in (''014'',''023'')', 'CAMAST', 'frmCAMAST', 'AUTOID DESC', NULL, 0, 500, 'N', 1, 'YYYYYYNNNNY', 'Y', 'T', NULL, 'N', NULL);COMMIT;