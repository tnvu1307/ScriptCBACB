SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('AFSELIMIT','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('AFSELIMIT', 'Quy định giá trị CK vay tối đa cho tiểu khoản', 'Stock lending max limit on sub account', 'select lm.afacctno,lm.autoid,sb.symbol, lm.codeid, lm.afmaxamt,
...
and mrt.mrtype in (''S'',''T'')', 'AFSELIMIT', 'frmAFSELIMIT', NULL, NULL, NULL, 5000, 'N', 1, NULL, 'Y', 'T', NULL, 'N', NULL);COMMIT;