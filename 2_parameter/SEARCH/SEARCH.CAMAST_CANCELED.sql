SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CAMAST_CANCELED','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CAMAST_CANCELED', 'Quyền đã hoàn tất', 'Completed corporate action events', 'SELECT VALUE, AUTOID, SYMBOL, CAMASTID, CODEID, EXCODEID, TYPEID, A1.<@CDCONTENT> CATYPE, KHQDATE,
...
(CASE WHEN STATUS IN (''P'',''N'') and deltd=''N'' THEN ''Y'' ELSE ''N'' END) DELALLOW
...
AND (ca.deltd=''Y'' OR  CA.STATUS=''C'') 
AND A2.CDTYPE = ''CA'' AND A2.CDNAME = ''CASTATUS''
AND CA.STATUS = A2.CDVAL
AND A4.CDTYPE = ''CA'' AND A4.CDNAME = ''FORMOFPAYMENT''
AND nvl(CA.FORMOFPAYMENT,''000'') = A4.CDVAL', 'CAMAST', 'frmCAMAST', 'AUTOID DESC', NULL, 0, 500, 'N', 1, 'NYYYYYNNNNY', 'Y', 'T', NULL, 'N', NULL);COMMIT;