...
OR (MST.STATUS =''H'' AND MST.TOACCTNO NOT IN (SELECT CUSTODYCD FROM CFMAST WHERE STATUS <> ''A'' AND CUSTATCOM=''Y'' AND CUSTODYCD IS NOT NULL)))', 'CAMAST', NULL, 'CAMASTID DESC', '3337', 0, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;