SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('UNHOLDORDER','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('UNHOLDORDER', 'Unhold số tiền phong tỏa trong ngày', 'Unhold blockade amount of the day', 'SELECT DD.CUSTODYCD, F.TXNUM REFTXNUM, DD.AFACCTNO SECACCOUNT, DD.ACCTNO DDACCTNO, CF.FULLNAME CUSTNAME,
...
)', 'UNHOLDORDER', '', 'CREATEDATE DESC, REQID DESC', '6691', NULL, 5000, 'N', 1, 'NNNNYYYNNN', 'Y', 'T', '', 'N', '');COMMIT;