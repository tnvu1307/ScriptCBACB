...
Insert into SEARCH
 ...
 Values
   ('CA3335', 'Tra cứu xác nhận danh sách người sở hữu chứng khoán lưu ký thực hiện quyền', 'Lookup confirmed list of holders of securities depository execution rights', 'SELECT CA.CAMASTID, CA.CODEID, SB.SYMBOL, CA.REPORTDATE, CA.DESCRIPTION, CA.VSDID,
