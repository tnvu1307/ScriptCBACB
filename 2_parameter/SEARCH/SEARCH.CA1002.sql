SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CA1002','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CA1002', 'Lấy ý kiến cổ đông, đại hội cổ đông, quyền bỏ phiếu (đối chiếu)', 'Collecting opinions of shareholders, general meeting of shareholders, voting rights (compare)', 'SELECT * FROM (
    ...
    AND CA.CATYPE IN (''005'',''006'',''022'',''028'')
    AND CAS.DELTD =''N''
    AND CA.DELTD=''N''
