...
LEFT JOIN ALLCODE A8 ON A8.CDTYPE=''SA'' AND A8.CDNAME=''DEPOSITORY'' AND A8.CDVAL = SB.DEPOSITORY', 'SEMAST', 'frmSEMAST', 'ISSUERID, CODEID', NULL, 0, 5000, 'N', 30, 'NNNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;