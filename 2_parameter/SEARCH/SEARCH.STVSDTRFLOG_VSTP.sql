SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('STVSDTRFLOG_VSTP','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('STVSDTRFLOG_VSTP', 'Điện trả lời từ VSD (VSTP)', 'Reply from VSD (VSTP)', 'SELECT DA.*,A2.CDCONTENT TYPESTP
FROM
(
...
WHERE DA.TYPE = A2.CDVAL(+)', 'ST.TTDIENR_VSTP', 'STVSDTRFLOG_VSTP', NULL, NULL, 0, 5000, 'Y', 1, NULL, 'Y', 'T', NULL, 'N', NULL);COMMIT;