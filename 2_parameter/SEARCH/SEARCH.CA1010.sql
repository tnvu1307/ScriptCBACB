SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CA1010','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CA1010', 'Đối chiếu cổ phiếu đăng ký nhận do chuyển đổi TP-nhận CP, hoặc tiền', 'Đối chiếu cổ phiếu đăng ký nhận do chuyển đổi TP-nhận CP, hoặc tiền', 'SELECT *
FROM
(
    SELECT MCF.CUSTODYCD, CAS.CAMASTID,
        ...
        SUM(CAS.BALANCE) BALANCE, SUM(CAS.QTTY) QTTY, SUM(CAS.AMT) AMT, SUM(CAS.AQTTY) AQTTY, SUM(CAS.AAMT) AAMT, SUM(CAS.TRADE) TRADE, SUM(CAS.PQTTY) PQTTY,
