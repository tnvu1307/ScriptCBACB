SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2317','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('SE2317', 'Tra cứu các tài khoản đã cầm cố chưa lên VSD để hủy (TPRL)(2317)', 'Look up blockade accounts that have not been listed on VSD for cancellation (PPBs)(2317)', 'SELECT SED.AUTOID, SED.TXDATE, SED.QTTY, SED.ACCTNO, SED.AFACCTNO, SED.QTTYTYPE, SED.PLACEID, SED.CONTRACTNO, SED.CONTRACTDATE,
    SB.CODEID, SB.SYMBOL,
...
(SELECT * FROM SEMORTAGE_TPRL WHERE TLTXCD = ''2316'' AND DELTD = ''N'' AND STATUS IN (''P'',''R'')) SED,
...
)', 'SE2317', 'frmSE2317', 'AUTOID DESC', '2317', 0, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;