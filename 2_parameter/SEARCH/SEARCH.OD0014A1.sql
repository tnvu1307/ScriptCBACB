SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('OD0014A1','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('OD0014A1', 'Nhận CK mua (TPRL)', 'Receive the buying securities for the buyer (PPBs)', 'SELECT MST.AUTOID, MST.ORDERID,  MST.AFACCTNO,  MST.AFACCTNO || MST.CODEID SEACCTNO, MST.CODEID, MST.QTTY, MST.AMT, MST.FEEAMT, MST.CLEARDATE SETTLEMENT, FA.SHORTNAME BROKER,
    DD.REFCASAACCT, A1.<@CDCONTENT> TYPEORDER, MST.VAT TAXAMT,
    MST.CUSTODYCD, MST.SYMBOL, MST.DDACCTNO, A1.CDVAL, A2.<@CDCONTENT> ASSETTYPE
...
)', 'OD0014A1', 'frmOD0014A1', NULL, '8819', NULL, 5000, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;