SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CF0137','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CF0137', 'Tạo yêu cầu đăng ký mã nhà đầu tư cho khách hàng nước ngoài( GD0137- Cấp Trading code)', 'Create a new investor register foreign customer information(GD0137- Issue Trading code)', 'SELECT MST.CUSTID, MST.CUSTODYCD, MST.FULLNAME, MST.IDCODE, MST.IDDATE, MST.IDPLACE,
...
A3.<@CDCONTENT> DESC_IDTYPE, A4.<@CDCONTENT> DESC_COUNTRY,MST.IDEXPIRED, MST.OPNDATE, A5.<@CDCONTENT> NSDSTATUS, nvl(tlp.tlname,'''') TLID ,
 nvl(tlp1.tlname,'''') LAST_OFID,MST.NSDSTATUS CFVSDSTATUS,MST.DATEOFBIRTH, MST.CUSTTYPE, A6.CDCONTENT CUSTTYPENAME, MST.SIDC
FROM CFMAST MST, ALLCODE A0, ALLCODE A1,ALLCODE A3, ALLCODE a4,allcode a5,tlprofiles tlp , ALLCODE a6, tlprofiles tlp1
where MST.NSDSTATUS=''I'' and mst.status != ''P''
...
AND MST.COUNTRY <> ''234''', 'CFMAST', 'frmSATLID', 'CUSTODYCD', '0137', NULL, 50, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;