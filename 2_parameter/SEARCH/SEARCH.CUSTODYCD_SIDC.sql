SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CUSTODYCD_SIDC','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CUSTODYCD_SIDC', 'Thông tin tài khoản lưu ký', 'Custody code information', 'SELECT format_custid(CF.CUSTID) CUSTID, CF.CUSTODYCD,CF.CIFID,
    ...
    CF.FOCUSTYPE FOCUSTYPE1,CF.REFNAME REFNAME1, MRLOANLIMIT, CF.TRADINGCODE, CF.TRADINGCODEDT, CF.SIDC, CF.PCOD,
    (CASE WHEN CF.STATUS IN (''B'',''C'',''N'') THEN ''N'' ELSE ''Y'' END) EDITALLOW,
    (CASE WHEN CF.STATUS IN (''P'') THEN ''Y'' ELSE ''N'' END) APRALLOW, ''Y'' DELALLOW
FROM CFMAST CF, AFMAST AF, TLGROUPS GRP, ALLCODE A1, ALLCODE A2, ALLCODE A3, ALLCODE A5, 
    ALLCODE A6, ALLCODE A7, ALLCODE A8, ALLCODE A9, ALLCODE A10, ALLCODE A11, ALLCODE A12, 
    ALLCODE A13, ALLCODE A14, ALLCODE A15, ALLCODE A16, ALLCODE A17, ALLCODE A18, ALLCODE A19, 
    ALLCODE A20, ALLCODE A21, ALLCODE A22, ALLCODE A23
