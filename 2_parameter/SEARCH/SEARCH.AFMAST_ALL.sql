SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('AFMAST_ALL','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('AFMAST_ALL', 'Quản lý tiểu khoản', 'Sub account management', 'Select a.*, nvl(LIMITMAX,0)LIMITMAX ,nvl(USERHAVE,0)USERHAVE,
...
SELECT mst.SHORTNAME, mst.ACTYPE, mst.ACNAME, format_custid(mst.CUSTID) CUSTID,mst.ACCTNO ACCTNO_SRCH,
    ...
    mst.MRCRLIMIT, mst.MRCRLIMITMAX, NVL(USF.ACCLIMIT,0) ACCLIMIT, mst.COUNTRY, mst.EDITALLOW,
...
where MST.ACCTNO =USF.ACCTNO (+)
    ...
    from userlimit US where US.tliduser=''<$TELLERID>'') us on 0=0', 'AFMAST_ALL', 'frmAFMAST', NULL, NULL, NULL, 5000, 'N', 1, NULL, 'Y', 'T', NULL, 'N', NULL);COMMIT;