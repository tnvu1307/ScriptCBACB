SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('UNHOLDORDERTPRL','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('UNHOLDORDERTPRL', 'Unhold số tiền phong tỏa trong ngày TPRL', 'Unhold blockade amount of the day PPBs', 'SELECT DD.CUSTODYCD, F.TXNUM REFTXNUM, CRB.TXDATE REFTXDATE, DD.AFACCTNO SECACCOUNT, DD.ACCTNO DDACCTNO, CF.FULLNAME CUSTNAME,
...
AND CRB.REQCODE = ''BANKHOLDEDBYBROKERTPRL''
...
)', 'UNHOLDORDERTPRL', NULL, 'CREATEDATE DESC, REQID DESC', '6691', NULL, 5000, 'N', 30, 'NNNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;