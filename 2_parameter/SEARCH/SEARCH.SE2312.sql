SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2312','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('SE2312', 'Tra cứu các tài khoản chuyển ra ngoài chưa gửi lên VSD để hủy (TPRL)(2312)', 'Look up accounts transferred out that have not been sent to VSD for cancellation (PPBs)(2312)', 'SELECT SED.AUTOID, SED.TXDATE, SED.QTTY, SED.ACCTNO, SED.AFACCTNO, SED.QTTYTYPE, SED.REFERENCEID, SED.RECCUSTODYCD, SED.RECMEMBER, SED.YBEN,
    SB.CODEID, SB.SYMBOL,
