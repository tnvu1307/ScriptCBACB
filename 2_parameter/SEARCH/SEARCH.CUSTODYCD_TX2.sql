SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CUSTODYCD_TX2','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CUSTODYCD_TX2', 'Thông tin tài khoản lưu ký', 'Custody code information', 'SELECT format_custid(CF.CUSTID) CUSTID, CF.CUSTODYCD,CF.CIFID,CF.MCUSTODYCD,
...
(CASE WHEN CF.STATUS IN (''P'') THEN ''Y'' ELSE ''N'' END) APRALLOW, ''Y'' DELALLOW, CF2.FULLNAME MFULLNAME
FROM
...
,(select fullname, custodycd from cfmast) CF2
WHERE
AF.CUSTID=CF.CUSTID 
AND AF.CAREBY = GRP.GRPID
and CF.MCUSTODYCD = CF2.CUSTODYCD  
...
AND (SUBSTR(CF.CUSTID,1,4) = DECODE(''<$BRID>'', ''<$HO_BRID>'', SUBSTR(CF.CUSTID,1,4), ''<$BRID>'')
    ...
    )', 'CFLINK', 'frmCFMAST', NULL, NULL, 0, 5000, 'N', 30, NULL, 'Y', 'T', NULL, 'N', NULL);COMMIT;