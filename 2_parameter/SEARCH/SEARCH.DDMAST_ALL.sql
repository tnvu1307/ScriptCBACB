SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('DDMAST_ALL','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('DDMAST_ALL', 'Quản lý tài khoản tiền', 'DD account management', 'select CF.CUSTODYCD, CF.FULLNAME, DD.AFACCTNO, DD.ACCTNO, DD.CCYCD, DD.REFCASAACCT,DD.BALANCE, DD.HOLDBALANCE,
