...
NOT IN (SELECT REFKEY FROM TLLOGEXT WHERE TLTXCD=''2240'' AND DELTD=''N'' AND STATUS IN (''0'',''1'', ''3'',''4'') )', 'SEMAST', 'frmSEMAST', NULL, '2240', NULL, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;