SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('BROKERVSDHIST','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('BROKERVSDHIST', 'Đối chiếu lịch sử nguồn Broker và VSD', 'Reconcile history source Broker and VSD', 'SELECT VW.NOTE1, VW.NOTE, VW.ISODMAST, VW.CUSTMEMBER, VW.CMPMEMBER, VW.VSDMEMBER, A.<@CDCONTENT> SUPERBANK, CF.CUSTODYCD, VW.SYMBOL, SB.ASSETTYPE, VW.TRANSTYPE, VW.TRADEDATE, VW.TRADEDATECTCK, VW.TRADEDATEVSD, VW.CUSTSETTLEDATE, VW.CMPSETTLEDATE, VW.VSDSETTLEDATE,
...
FROM V_COMPARE_BROKERVSDHIST VW,
...
ORDER BY VW.CMPMEMBER, VW.NOTE1', 'BROKERVSDHIST', NULL, 'TXTIME desc', NULL, 0, 5000, 'N', 30, 'NNNNYYYNNN', 'N', 'T', NULL, 'N', NULL);COMMIT;