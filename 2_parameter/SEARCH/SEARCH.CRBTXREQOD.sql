...
) GROUP BY CTCK,EXECTYPE,TXDATE,AMOUNT,FEE,TAX,ORDERID,CODEID , SYMBOL, CUSTODYCD,ACCOUNTNO, DDACCTNO,CUSTNAME,REFCASAACCT,BALANCE,HOLDBALANCE,MEMBERID,BRNAME,BRPHONE,CDVAL,BANKHOLDEDBYBROKER,CIFID', 'CRBTXREQOD', '', '', '6690', NULL, 5000, 'N', 1, 'NNNNYYYNNN', 'Y', 'T', '', 'N', '');COMMIT;