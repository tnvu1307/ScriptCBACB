SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CFMAST_NOCAREBY','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CFMAST_NOCAREBY', 'Thông tin khách hàng', 'Customer information', 'SELECT format_custid(CF.CUSTID) CUSTID,
CF.CUSTODYCD,
...
(CASE WHEN CF.STATUS IN (''P'') THEN ''Y'' ELSE ''N'' END) APRALLOW, ''Y'' DELALLOW, CF.RISKLEVEL, CF.ACTIVESTS, CF.CUSTTYPE
FROM
...
AND A23.CDTYPE = ''SY'' AND A23.CDNAME = ''YESNO'' AND A23.CDVAL= CF.ISBANKING', 'CFMAST_NOCAREBY', 'frmCFMAST', NULL, NULL, NULL, 5000, 'N', 1, NULL, 'Y', 'T', NULL, 'N', NULL);COMMIT;