SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2324','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('SE2324', 'Tra cứu các tài khoản đã gửi hồ sơ giải cầm cố lên VSD để hoàn tất (TPRL)(2324)', 'Look up accounts that have sent released records to VSD for complete (PPBs)(2324)', 'SELECT SED.AUTOID, SED.TXDATE, SED.QTTY, SED.ACCTNO, SED.AFACCTNO, SED.QTTYTYPE, SED.PLACEID, SED.CONTRACTNO, SED.CONTRACTDATE,
    SB.CODEID, SB.SYMBOL,
...
)', 'SE2324', 'frmSE2324', 'AUTOID DESC', '2324', 0, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;