SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CFMASTAITHER','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CFMASTAITHER', 'Đồng bộ thông tin khách hàng từ Aither', 'Customer information', 'SELECT A.REQID, A.ACTIONTYPE ACTIONTYPEVAL, A1.CDCONTENT ACTIONTYPE, CF.CUSTID,
...
AND A.STATUS =''P''', 'CFMASTAITHER', '', 'REQID desc', '6679', NULL, 5000, 'N', 1, 'NNNNYYYNNN', 'Y', 'T', '', 'N', '');COMMIT;