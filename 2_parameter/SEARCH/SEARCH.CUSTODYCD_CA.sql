SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CUSTODYCD_CA','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CUSTODYCD_CA', 'Thông tin tài khoản lưu ký', 'Custody code information', 'SELECT format_custid(CF.CUSTID) CUSTID, CF.CUSTODYCD,CF.CIFID,
...
FROM
    (
SELECT * FROM CASCHD WHERE STATUS IN (''J'', ''W'', ''C'')
    )CAS,CFMAST CF, AFMAST AF,TLGROUPS GRP, ALLCODE A1, ALLCODE A2,ALLCODE A3,ALLCODE A5,ALLCODE A6,ALLCODE A7,ALLCODE A8,ALLCODE A9,ALLCODE A10, ALLCODE A11,ALLCODE A12,ALLCODE A13,ALLCODE A14,ALLCODE A15,ALLCODE A16,ALLCODE A17, ALLCODE A18,ALLCODE A19,ALLCODE A20,ALLCODE A21,ALLCODE A22, ALLCODE A23
WHERE
AF.CUSTID=CF.CUSTID 
...
AND CAS.AFACCTNO = CF.CUSTID AND CAS.CAMASTID = ''<@KEYVALUE>''
AND (SUBSTR(CF.CUSTID,1,4) = DECODE(''<$BRID>'', ''<$HO_BRID>'', SUBSTR(CF.CUSTID,1,4), ''<$BRID>'')
    ...
    )', 'CFLINK', 'frmCFMAST', NULL, NULL, NULL, 5000, 'N', 30, NULL, 'Y', 'T', NULL, 'N', NULL);COMMIT;