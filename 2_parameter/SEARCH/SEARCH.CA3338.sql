SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CA3338','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CA3338', 'Danh sách khách hàng cắt tiền đăng ký quyền mua', 'List of customers cut money to register the right issue', 'SELECT MST.*,CF.CIFID, DD.ACCTNO, DD.CCYCD, ''D'' DORC,CA.DEBITDATE,CA.ISINCODE, CA.TOCODEID CODEID,
...
AND DD.status =''A''
AND CF.CUSTODYCD = MST.CUSTODYCD', 'CAMAST', NULL, 'DEBITDATE DESC', '3338', 0, 5000, 'N', 30, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;