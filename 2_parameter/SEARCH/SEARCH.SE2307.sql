SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2307','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('SE2307', 'Tra cứu các tài khoản đã rút lưu ký chưa lên VSD để hủy (TPRL)(2307)', 'Look up deposited accounts that have not been submitted to VSD for cancellation (PPBs)(2307)', 'SELECT SED.AUTOID, SED.TXDATE, SED.QTTY, SED.ACCTNO, SED.AFACCTNO, SED.QTTYTYPE, SED.REFERENCEID, 
    SB.CODEID, SB.SYMBOL,
...
(SELECT * FROM SEWITHDRAWDTL_TPRL WHERE DELTD = ''N'' AND STATUS IN (''P'',''R'')) SED,
...
)', 'SE2307', 'frmSE2307', 'AUTOID DESC', '2307', 0, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;