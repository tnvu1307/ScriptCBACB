SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SE2319','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('SE2319', 'Tra cứu các tài khoản đã gửi hồ sơ cầm cố lên VSD để hoàn tất (TPRL)(2319)', 'Look up accounts that have sent blockade records to VSD for complete (PPBs)(2319)', 'SELECT SED.AUTOID, SED.TXDATE, SED.QTTY, SED.ACCTNO, SED.AFACCTNO, SED.QTTYTYPE, SED.PLACEID, SED.CONTRACTNO, SED.CONTRACTDATE,
    SB.CODEID, SB.SYMBOL,
...
)', 'SE2319', 'frmSE2319', 'AUTOID DESC', '2319', 0, 5000, 'N', 1, 'NYNNYYYNNN', 'Y', 'T', NULL, 'N', NULL);COMMIT;