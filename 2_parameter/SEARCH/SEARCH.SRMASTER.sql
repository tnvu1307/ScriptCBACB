SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('SRMASTER','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('SRMASTER', 'Quản lý room đặc biệt', 'Special Room Management', 'SELECT MST.PRCODE, MST.PRNAME, A0.CDCONTENT P_PRTYPE, SB.SYMBOL, A1.CDCONTENT P_PRSTATUS, MST.PRLIMIT,
        ...
        (CASE WHEN PRSTATUS IN (''P'') THEN ''Y'' ELSE ''N'' END) APRALLOW, MST.ROOMTYP ROOMTYP, MST.PRTYP PRTYP, MST.PRSTATUS PRSTATUS, MST.Valdate
FROM PRMASTER MST,
...
WHERE MST.CODEID=SB.CODEID(+) AND A0.CDTYPE=''SY''
     ...
     and mst.prcode = prlog.prcode(+) and ROOMTYP=''SPR'' ', 'SRMASTER', 'PRCODE', NULL, NULL, NULL, 5000, 'N', 1, NULL, 'Y', 'T', NULL, 'N', NULL);COMMIT;