SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('BROKER','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('BROKER', 'Đối chiếu 1 nguồn broker', 'Reconcile 1 source broker', 'SELECT VW.NOTE1, VW.NOTEVSBR, VW.NOTE, VW.ISODMAST, VW.CUSTMEMBER, VW.CMPMEMBER, VW.VSDMEMBER, A.<@CDCONTENT> SUPERBANK, CF.CUSTODYCD, VW.SYMBOL, SB.ASSETTYPE, VW.TRANSTYPE, VW.TRADEDATE, VW.TRADEDATECTCK, VW.TRADEDATEVSD, VW.CUSTSETTLEDATE, VW.CMPSETTLEDATE, VW.VSDSETTLEDATE,
...
FROM V_COMPARE_IMPORT_ONLY_BROKER VW,
...
AND CF.SUPEBANK = A.CDVAL(+)', 'BROKER', NULL, 'cmpmember,note1', NULL, 0, 5000, 'N', 1, 'NNNNYYYNNN', 'N', 'T', NULL, 'N', NULL);COMMIT;