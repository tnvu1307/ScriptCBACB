SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('CRBVOUCHER','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT) Values   ('CRBVOUCHER', 'Danh sách bảng kê', 'List management', 'SELECT MST.AUTOID, MST.VERSION, MST.TXDATE, MST.AFFECTDATE, MST.REFBANK, MST.CREATETST, MST.SENDTST,
...
AND MST.ERRCODE=ERR.ERRNUM(+)', 'CRBVOUCHER', 'frmPRINT', NULL, NULL, NULL, 5000, 'N', 1, 'NYYNYYNNNNY', 'Y', 'T', NULL, 'N', NULL);COMMIT;