SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW VW_CA1051_DEL_N
(CAMASTID, CATYPE, SYMBOL, REPORTDATE, ACTIONDATE, 
 CAPTUREDATE, REPORTDATEPASS, RATE, DELTD)
AS 
select a."CAMASTID",a."CATYPE",a."SYMBOL",a."REPORTDATE",a."ACTIONDATE",a."CAPTUREDATE",a."REPORTDATEPASS",a."RATE",a."DELTD" from (
