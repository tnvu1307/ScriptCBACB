SET DEFINE OFF;
CREATE OR REPLACE FORCE VIEW V_CA3312_DEL_N
...
(
    SELECT CA.AUTOID, CA.TRADE, CA.PBALANCE, CA.AFACCTNO, CA.CODEID, CA.EXCODEID, CA.QTTY, CA.STATUS, SUBSTR(CA.CAMASTID,1,4) || '.' || SUBSTR(CA.CAMASTID,5,6) || '.' ||SUBSTR(CA.CAMASTID,11,6) CAMASTID,
           ...
           (CASE WHEN CAMAST.CATYPE IN ('016') THEN CA.INTAMT ELSE CA.AMT END ) AMT, CAMAST.deltd
    FROM caschd_list CA, SBSECURITIES SYM, SBSECURITIES SYMTO, SBSECURITIES EXSYM, CAMAST, AFMAST AF, CFMAST CF
...
VW.IDCODE,VW.ADDRESS,VW.CASTATUS,VW.PITRATEMETHOD,VW.PITRATE,VW.MCUSTODYCD,VW.MCIFID,VW.DELTD
/
