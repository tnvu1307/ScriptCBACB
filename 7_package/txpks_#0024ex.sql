...
BEGIN
    ...
    ***************************************************************************************************/
    ...
    SELECT COUNT(1) INTO l_count FROM userlogin WHERE username = p_txmsg.txfields(c_username).value AND status <> 'P';
    IF NOT l_count = 1 THEN
      p_err_code := '-100313'; -- Pre-defined in DEFERROR table
      plog.setendsection (pkgctx, 'fn_txPreAppCheck');
      RETURN errnums.C_BIZ_RULE_INVALID;
    END IF;
...
BEGIN
    ...
    ***************************************************************************************************/
    l_username := p_txmsg.txfields(c_username).value;
    ...
    SELECT email INTO l_email FROM userlogin WHERE username = l_username AND status <> 'P';
