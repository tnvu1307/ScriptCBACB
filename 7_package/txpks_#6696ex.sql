SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#6696ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6696EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#6696ex
IS
   pkgctx   plog.log_ctx;
...
BEGIN
    ...
    ***************************************************************************************************/
    ...
    if not p_txmsg.txfields('05').value is null then
        pr_gen_buf_dd_member(p_txmsg.txfields('04').value ,p_txmsg.txfields(c_memberid).value,(ROUND(p_txmsg.txfields('10').value,0)),-(ROUND(p_txmsg.txfields('10').value,0)),0,0,p_txmsg.txfields('10').value,0) ;
    end if;
