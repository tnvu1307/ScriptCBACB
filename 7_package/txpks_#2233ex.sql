...
BEGIN
    ...
    ***************************************************************************************************/
    ...
    IF p_txmsg.deltd <> 'Y' THEN
        ...
        VALUES(seq_semortage.nextval,v_strACCTNO,v_strAFACCTNO,V_TLTXCD,v_txnum,V_txdate,v_nAMT,'E','N','N',NULL,NULL,V_STRDESC,v_issuesid);


        INSERT INTO semortage (AUTOID,ACCTNO,AFACCTNO,TLTXCD,TXNUM,TXDATE,QTTY,STATUS,DELTD,PSTATUS,TXNUM_MTG,TXDATE_MTG,DESCRIPTION, REFID,ISSUESID)
        VALUES(seq_semortage.nextval,v_strACCTNO,v_strAFACCTNO,V_TLTXCD,v_txnum,V_txdate,v_nAMT,'N','N','N',NULL,NULL,V_STRDESC,p_txmsg.txfields('50').value, v_issuesid );
