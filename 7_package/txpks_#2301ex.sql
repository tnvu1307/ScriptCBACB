SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#2301ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#2301EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#2301ex
IS
   pkgctx   plog.log_ctx;
...
BEGIN
    ...
    ***************************************************************************************************/
    IF p_txmsg.deltd <> 'Y' THEN
        ...
        INSERT INTO SEDEPOSIT_TPRL(AUTOID, TXDATE, TXNUM, BUSDATE, CODEID, AFACCTNO, ACCTNO, CUSTODYCD, MCUSTODYCD, QTTY, QTTYTYPE, REFERENCEID)
        VALUES (SEQ_SEDEPOSIT_TPRL.NEXTVAL, P_TXMSG.TXDATE, P_TXMSG.TXNUM, P_TXMSG.BUSDATE, L_CODEID, L_AFACCTNO, L_ACCTNO, L_CUSTODYCD, L_MCUSTODYCD, L_QTTY, L_QTTYTYPE, L_REFERENCEID);

        INSERT INTO SETRAN(TXNUM, TXDATE, ACCTNO, TXCD, NAMT, CAMT, ACCTREF, DELTD, REF, AUTOID, TLTXCD, BKDATE, TRDESC)
        VALUES (P_TXMSG.TXNUM, P_TXMSG.TXDATE, L_ACCTNO, '0050', L_QTTY, NULL, '', P_TXMSG.DELTD, '', SEQ_SETRAN.NEXTVAL, P_TXMSG.TLTXCD, P_TXMSG.BUSDATE, '');

        UPDATE SEMAST
        SET DEPOSIT = DEPOSIT + L_QTTY, LAST_CHANGE = SYSTIMESTAMP
