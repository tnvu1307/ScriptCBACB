SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#6622ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6622EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#6622ex
IS
   pkgctx   plog.log_ctx;
   ...
   c_banknostroacct   CONSTANT CHAR(2) := '18';
   c_banknostroname   CONSTANT CHAR(2) := '19';
   c_dorc             CONSTANT CHAR(2) := '91';
   c_citad            CONSTANT CHAR(2) := '13';
   c_bankcitad        CONSTANT CHAR(2) := '15';
   c_branchcitad      CONSTANT CHAR(2) := '16';
    ...
    IF p_txmsg.deltd <> 'Y' THEN -- Normal transaction
        ...
        INSERT INTO crbtxreq (reqid,
          ...
          VALUES   (seq_crbtxreq.NEXTVAL,
                    ...
                    NULL,
                    p_txmsg.txfields ('13').VALUE,
                    p_txmsg.txfields ('30').VALUE,'N',p_txmsg.txfields ('91').VALUE,TO_DATE (p_txmsg.busdate, systemnums.c_date_format));
