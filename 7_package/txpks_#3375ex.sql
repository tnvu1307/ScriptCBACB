        ...
        IF length(l_camastid) > 0 THEN
            ...
            -- Tinh gia tri chung khoan cho quyen ve.
                IF l_catype = '009' THEN --gc_CA_CATYPE_KIND_DIVIDEND  'Kind dividend
                    l_qttyexp := 'FLOOR(((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_devidentshares || ')/' || l_left_devidentshares || ')';
                    l_amtexp := '(' || l_exprice || '*MOD((SUM(MST.TRADE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_devidentshares || ' ,' || l_left_devidentshares || '))/' || l_left_devidentshares;
                    L_ROUND:= ' (CASE WHEN ( MOD((SUM(MST.TRADE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_devidentshares || ' ,' || l_left_devidentshares || '))> 0 THEN 1 ELSE 0 END) ';
                ELSIF l_catype = '010' THEN --gc_CA_CATYPE_CASH_DIVIDEND 'Cash dividend(+QTTY,AMT)
                    if(l_TYPERATE= 'R') THEN
                        l_amtexp := '(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*MAX(SYM.PARVALUE)/100*' || l_devidentrate;
                    ELSE
                      l_amtexp := '(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_devidentvalue;
                    END IF;
                    l_roundtype :=0;
                ...
                ELSIF l_catype = '011' THEN --gc_CA_CATYPE_STOCK_DIVIDEND 'Stock dividend (+QTTY,AMT)
                    l_qttyexp:= '(((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_devidentshares || ')/' || l_left_devidentshares || ')';
                    l_amtexp:= '(' || l_exprice || '* TRUNC( MOD((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_devidentshares || ' ,' || l_left_devidentshares || ')/' || l_left_devidentshares||',' || l_ciroundtype|| '))';
                    L_ROUND:= ' (CASE WHEN (((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_devidentshares || ' / ' || l_left_devidentshares || ')- '
                                || ' TRUNC((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_devidentshares || ' / ' || l_left_devidentshares || ', '||L_ROUNDTYPE ||' ))> 0 THEN 1 ELSE 0 END) ';

                ELSIF l_catype = '025' THEN --gc_CA_CATYPE_PRINCIPLE_BOND
                    l_amtexp:='(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_exprice;
                    l_aamtexp:='(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))';

                ELSIF l_catype = '021' THEN --gc_CA_CATYPE_KIND_STOCK

                    l_qttyexp:= '(((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_exrate || ')/' || l_left_exrate || ')';
                    l_amtexp:= '(' || l_exprice || ' * TRUNC( MOD((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_exrate || ' ,' || l_left_exrate || ')/' || l_left_exrate||', '|| l_ciroundtype ||'))';
                ...
                ELSIF l_catype = '022' THEN --gc_CA_CATYPE_CASH_DIVIDEND 'Cash dividend(+QTTY,AMT)
                    l_qttyexp := '(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))';
                    L_ROUND:= ' (CASE WHEN ( MOD((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_devidentshares || ' ,' || l_left_devidentshares || '))> 0 THEN 1 ELSE 0 END) ';

                    l_rqttyexp:= 'FLOOR(((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_devidentshares || ')/' || l_left_devidentshares || ')';
                ELSIF l_catype = '012' THEN --gc_CA_CATYPE_STOCK_SPLIT 'Stock Split(+ QTTY,AMT)
                    l_qttyexp:= 'TRUNC((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT)) / (' || l_splitrate || ') - '
                                   || '(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT)), ' || l_roundtype || ')';
                    l_amtexp:= l_exprice || '*((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT)) / (' || l_splitrate || ') - '
                                             || '(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT)) - '
                                             || l_qttyexp || ')';

                ELSIF l_catype = '013' THEN --gc_CA_CATYPE_STOCK_MERGE 'Stock Merge(-AQTTY,+AMT)
                    l_aqttyexp:='((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT)) - '
                                    || 'TRUNC((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT)) / (' || l_splitrate || '), ' || l_roundtype || '))';
                    l_aamtexp:= l_exprice || '*( ' || l_aqttyexp || ' - ((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT)) - '
                                    || '(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT)) / (' || l_splitrate || ')))';

                   -- PhuongHT edit
                    l_amtexp:= l_exprice || '*( ' || l_aqttyexp || ' - ((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT)) - '
                                    || '(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT)) / (' || l_splitrate || ')))';

                   -- end of PhuongHT edit
                ELSIF l_catype = '014' THEN --gc_CA_CATYPE_STOCK_RIGHTOFF 'Stock Rightoff(+QTTY,-AAMT)
                    l_qttyexp:=v_qttyround || '(((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_rightoffrate ||'*'|| l_right_exrate || ')/(' || l_left_rightoffrate || '*'|| l_left_exrate ||'))';
                    l_aamtexp:= l_exprice || ' * TRUNC( FLOOR((( SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_rightoffrate ||'*'|| l_right_exrate|| ')/(' || l_left_rightoffrate || '*'|| l_left_exrate ||')), ' || l_roundtype || ')';
                    L_ROUND:= ' (CASE WHEN (((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_exrate || ' / ' || l_left_exrate || ')- '
                                || ' TRUNC((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_right_exrate || ' / ' || l_left_exrate ||', '||L_ROUNDTYPE ||' ))> 0 THEN 1 ELSE 0 END) ';
                ...
                ELSIF l_catype = '015' THEN --gc_CA_CATYPE_BOND_PAY_INTEREST 'Bond pay interest, Lai suat theo thang, chu ky theo nam (+AMT)
                    l_amtexp:='(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*MAX(SYM.PARVALUE)/(100)*' || l_interestrate ;
                    l_roundtype := 0;
                    L_ROUND:= ' (CASE WHEN (FLOOR( '|| l_amtexp  || ') ) <> '|| l_amtexp || ' THEN 1 ELSE 0 END)';
                    -- amt=intamt
                    l_intamtexp:='(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*MAX(SYM.PARVALUE)/(100)*' || l_interestrate ;
                ELSIF l_catype = '016' THEN -- gc_CA_CATYPE_BOND_PAY_INTEREST_PRINCIPAL 'Bond pay interest || prin, Lai suat theo thang, chu ky theo nam (+AMT)
                    l_amtexp:='(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*MAX(SYM.PARVALUE) + '
                                    || '(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*MAX(SYM.PARVALUE)/(100*12)*' || l_interestrate || '*' || l_interestperiod;

                    l_amtexp:='(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*MAX(SYM.PARVALUE) * (1+ ' || l_interestrate || ' /100 ) ';
                     -- PhuongHT: ghi nhan rieng phan lai
                    l_intamtexp:='(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*MAX(SYM.PARVALUE)/(100)*' || l_interestrate ;
               ...
               --Ngay 04/02/2020 NamTv them su kien 033 tuong tu 016
                ELSIF l_catype = '033' THEN -- gc_CA_CATYPE_BOND_PAY_INTEREST_PRINCIPAL 'Bond pay interest || prin, Lai suat theo thang, chu ky theo nam (+AMT)
                    ...
                    l_amtexp:='(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*MAX(SYM.PARVALUE) * (1+ ' || l_splitrate || ' /100 ) ';
                     -- PhuongHT: ghi nhan rieng phan lai
                    l_intamtexp:='(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))* (' || l_splitrate ||'/100*MAX(SYM.PARVALUE))';
                    L_ROUND:= ' (CASE WHEN (FLOOR( '|| l_amtexp  || ') ) <> '|| l_amtexp || ' THEN 1 ELSE 0 END)';
                    l_roundtype:= 0 ;
                ...
                ELSIF l_catype = '024' THEN --gc_CA_CATYPE_CASH_CW 'Chi tra loi tuc CW bang tien
                    ...
                    if(l_TYPERATE= 'R') THEN
                        l_amtexp := '(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*'||l_exprice||'/100*' || l_devidentrate;
                    ELSE
                        l_amtexp := '(SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD)-SUM(TR.AMOUNT))*' || l_devidentvalue;
                    END IF;
                    --l_roundtype :=0;
                ...
                IF l_catype = '014' THEN
                    l_sql := 'INSERT INTO CASCHDTEMP (AUTOID, CAMASTID, AFACCTNO, CODEID, EXCODEID, BALANCE, QTTY, AMT, AQTTY, AAMT, STATUS,REQTTY,REAQTTY,RETAILBAL,PBALANCE, PQTTY,PAAMT,TRADE,ROUND)  '
                              ...
                              || ' ,TRUNC('||v_qttyround||'((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD) - SUM(TR.AMOUNT))*'||l_right_exrate||'/'|| l_left_exrate||'),'|| l_roundtype ||') RETAILBAL,'
                              || ' TRUNC('||v_qttyround||'((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD) - SUM(TR.AMOUNT))*'||l_right_exrate||'/'||l_left_exrate||'),'|| l_roundtype ||') PBALANCE, '
                              || nvl(l_qttyexp,'''''') || '  PQTTY,  ROUND(' || nvl(l_aamtexp,'''''') || ',0) PAAMT,'
                              || ' TRUNC((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD) - SUM(TR.AMOUNT))) TRADE, '|| l_round ||' ROUND'
                ...
                ELSIF l_catype = '022' THEN
                    l_sql := 'INSERT INTO CASCHDTEMP (AUTOID, CAMASTID, AFACCTNO, CODEID, EXCODEID, BALANCE, QTTY, AMT, AQTTY, AAMT, STATUS,REQTTY,REAQTTY,RETAILBAL,TRADE,RQTTY,round)  '
                             ...
                             || ' (SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD) - SUM(TR.AMOUNT)) BALANCE, '
                             ...
                             || ' , 0  RETAILBAL,  '
                              || ' TRUNC((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD) - SUM(TR.AMOUNT))) TRADE, ROUND(' || nvl(l_rqttyexp,'''''') || ',0) RQTTY, '|| l_round ||' ROUND'
                             || ' FROM SBSECURITIES SYM, CAMAST CA, SEMAST MST,  '
                             || ' (SELECT MST.ACCTNO, NVL(DTL.AMT,0) AMOUNT FROM SEMAST MST LEFT JOIN '
                             || ' (select DTL.ACCTNO, sum(DTL.AMT) amt From '
                             || ' (SELECT TR.ACCTNO, SUM((CASE WHEN TX.TXTYPE=''D'' THEN -TR.NAMT WHEN TX.TXTYPE=''C'' THEN TR.NAMT ELSE 0 END)) AMT  '
                             || ' FROM APPTX TX, SETRAN TR ,TLLOG TL '
                             || ' WHERE TX.APPTYPE=''SE'' AND TRIM(TX.FIELD) IN (''TRADE'',''BLOCKWITHDRAW'',''EMKQTTY'',''BLOCKDTOCLOSE'',''MARGIN'',''WTRADE'',''MORTAGE'',''BLOCKED'',''SECURED'',''REPO'',''NETTING'',''DTOCLOSE'',''WITHDRAW'',''HOLD'')  '
                             || ' AND TR.TXDATE=TL.TXDATE AND TR.TXNUM=TL.TXNUM AND TX.TXTYPE IN (''C'', ''D'') AND TL.DELTD <> ''Y'' '
                             || ' AND TX.TXCD=TR.TXCD AND TL.BUSDATE > TO_DATE(''' || to_char(l_reportdate,systemnums.c_date_format) || ''', ''DD/MM/RRRR'') GROUP BY TR.ACCTNO  '
                             || ' UNION ALL  '
                             || ' SELECT TR.ACCTNO, SUM((CASE WHEN TX.TXTYPE=''D'' THEN -TR.NAMT WHEN TX.TXTYPE=''C'' THEN TR.NAMT ELSE 0 END)) AMT  '
                ...
                ELSIF l_catype = '017' THEN
                    l_sql := 'INSERT INTO CASCHDTEMP (AUTOID, CAMASTID, AFACCTNO, CODEID, EXCODEID, BALANCE, QTTY, AMT, AQTTY, AAMT, STATUS,REQTTY,REAQTTY,RETAILBAL,TRADE,ROUND)  '
                             ...
                             || ' (SELECT TR.ACCTNO, SUM((CASE WHEN TX.TXTYPE=''D'' THEN -TR.NAMT WHEN TX.TXTYPE=''C'' THEN TR.NAMT ELSE 0 END)) AMT  '
                             || ' FROM APPTX TX, SETRAN TR ,TLLOG TL '
                             || ' WHERE TX.APPTYPE=''SE'' AND TRIM(TX.FIELD) IN (''TRADE'',''MARGIN'',''WTRADE'',''BLOCKWITHDRAW'',''EMKQTTY'',''BLOCKDTOCLOSE'',''MORTAGE'',''BLOCKED'',''SECURED'',''REPO'',''NETTING'',''DTOCLOSE'',''WITHDRAW'',''HOLD'')  '
                             || ' AND TR.TXDATE=TL.TXDATE AND TR.TXNUM=TL.TXNUM AND TX.TXTYPE IN (''C'', ''D'') AND TL.DELTD <> ''Y'' '
                             || ' AND TX.TXCD=TR.TXCD AND TL.BUSDATE > TO_DATE(''' || to_char(l_reportdate,systemnums.c_date_format) || ''', ''DD/MM/RRRR'') GROUP BY TR.ACCTNO  '
                             || ' UNION ALL  '
                             || ' SELECT TR.ACCTNO, SUM((CASE WHEN TX.TXTYPE=''D'' THEN -TR.NAMT WHEN TX.TXTYPE=''C'' THEN TR.NAMT ELSE 0 END)) AMT  '
                ...
                ELSE
                    l_sql := 'INSERT INTO CASCHDTEMP (AUTOID, CAMASTID, AFACCTNO, CODEID, EXCODEID, BALANCE, QTTY, AMT, AQTTY, AAMT, STATUS,REQTTY,REAQTTY,RETAILBAL,TRADE,INTAMT,RQTTY,ROUND)  '
                             ...
                             || nvl(l_qttyexp,'''''') || '  QTTY, ROUND(' || nvl(l_amtexp,'''''') || ',0) AMT, ' || nvl(l_aqttyexp,'''''') || ' AQTTY, ROUND(' || nvl(l_aamtexp,'''''') || ',0) AAMT, ''A'' STATUS,' || nvl(l_reqttyexp,'''''') || '  REQTTY,' || nvl(l_reaqttyexp,'''''') || '  REAQTTY '
                             || ' , 0  RETAILBAL,  '
                              || ' TRUNC((SUM(MST.TRADE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD) - SUM(TR.AMOUNT))) TRADE, ROUND(' || nvl(l_intamtexp,'''''') || ',0) INTAMT, ROUND(' || nvl(l_rqttyexp,'''''') || ',0) RQTTY, '|| l_round ||' ROUND'
                             || ' FROM SBSECURITIES SYM, CAMAST CA, SEMAST MST,  '
                             || ' (SELECT MST.ACCTNO, NVL(DTL.AMT,0) AMOUNT FROM SEMAST MST LEFT JOIN '
                             || ' (select DTL.ACCTNO, sum(DTL.AMT) amt From '
                             || ' (SELECT TR.ACCTNO, SUM((CASE WHEN TX.TXTYPE=''D'' THEN -TR.NAMT WHEN TX.TXTYPE=''C'' THEN TR.NAMT ELSE 0 END)) AMT  '
  ...
  --T07/2017 STP
                    ...
                    FROM (
                        ...
                        CASE WHEN l_qttyround = 0 THEN
                         ...
                         FROM(
                             ...
                             --TRUNC((SUM(MST.TRADE + MST.MARGIN + MST.EMKQTTY + MST.WTRADE  + MST.MORTAGE + MST.SECURED + MST.REPO+ MST.NETTING+ MST.DTOCLOSE+MST.WITHDRAW) - SUM(TR.NTRADE))*(l_right_exrate/ l_left_exrate)) TRADE,
                             --TRUNC((SUM(MST.TRADE + MST.MARGIN + MST.EMKQTTY + MST.WTRADE  + MST.MORTAGE + MST.SECURED + MST.REPO+ MST.NETTING+ MST.DTOCLOSE+MST.WITHDRAW) - SUM(TR.NTRADE))*(l_right_rightoffrate / l_left_rightoffrate)) PTRADE,
                             ...
                             SUM(MST.TRADE + MST.MARGIN + MST.EMKQTTY + MST.WTRADE + MST.MORTAGE + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD) - SUM(TR.NTRADE) TRADEQTTY,
                             ...
                             (
                                 ...
                                 (
                                     ...
                                     (
                                         ...
                                         (
                                             SELECT TR.ACCTNO,
                                             SUM((CASE WHEN TRIM(TX.FIELD) IN ('TRADE','MARGIN','EMKQTTY','WTRADE','MORTAGE','SECURED','REPO','NETTING','DTOCLOSE','WITHDRAW','HOLD')
                                             ...
                                             WHERE TX.APPTYPE='SE' AND TRIM(TX.FIELD) IN ('TRADE','MARGIN','WTRADE','MORTAGE','SECURED','REPO','NETTING','DTOCLOSE','WITHDRAW','BLOCKED','HOLD')
                                             AND TR.TXDATE=TL.TXDATE AND TR.TXNUM=TL.TXNUM AND TX.TXTYPE IN ('C', 'D') AND TL.DELTD <> 'Y'
                ...
                FOR rec_trade IN (
                   select mst.* from
                       ...
                       FROM   (SELECT SUM(MST.TRADE + MST.MARGIN + MST.WTRADE + MST.MORTAGE + MST.BLOCKWITHDRAW + MST.EMKQTTY + MST.BLOCKDTOCLOSE + MST.BLOCKED + MST.SECURED + MST.REPO + MST.NETTING + MST.DTOCLOSE + MST.WITHDRAW + MST.HOLD) - SUM(TR.AMOUNT) trade,
                ...
                pr_error ('Gianhvg 3375ex','Phan bo xong tu caschdtemp vao caschd');
                 ...
                 END IF;
                    ...
                    IF l_catype = '014' THEN
                        ...
                        Where SE.afacctno=CHD.afacctno
                        AND SE.codeid=CHD.excodeid
                        ...
                        IF l_count  = 0 THEN
                            ...
                            select se.ACTYPE, se.CUSTID, se.afacctno || CHD.excodeid, CHD.excodeid, se.afacctno,
                                   SE.OPNDATE,SE.LASTDATE,SE.COSTDT, TBALDT,
                                   'A','Y','000',
                                   0,chd.PBALANCE,0,0,0,0,0,0,0,ABS(chd.qtty * CA.TRANSFERTIMES)
                            from semast se, caschd chd, camast ca
                            where SE.afacctno=CHD.afacctno
                            AND SE.codeid=CHD.codeid
                            AND CHD.camastid=CA.camastid
                            AND CA.camastid= l_camastid;
                        END IF;
                            --thunt-26/02/2020:them tang setran cho 3375
                            for rec in (
                            select se.afacctno || ca.optcodeid acctno,chd.PBALANCE trade,chd.afacctno --into l_acctno, l_trade
                            from semast se,caschd chd,camast ca
                            where SE.afacctno=CHD.afacctno AND SE.codeid=CHD.codeid AND ca.deltd ='N' and chd.deltd='N'
                            ...
                            '0045',rec.trade,NULL,rec.afacctno,
                            ...
                            update semast set TRADE = rec.trade where acctno = rec.acctno;
                            --end TramNN
                            end loop;
