SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#8897ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#8897EX
...
CREATE OR REPLACE PACKAGE BODY TXPKS_#8897EX
IS
   pkgctx   plog.log_ctx;
   logrow   tlogdebug%ROWTYPE;

   c_txdate           CONSTANT CHAR(2) := '20';
   c_acctno           CONSTANT CHAR(2) := '25';
