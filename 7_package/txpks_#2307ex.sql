SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#2307ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#2307EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#2307ex
IS
   pkgctx   plog.log_ctx;
    ...
    ***************************************************************************************************/
    IF P_TXMSG.DELTD <> 'Y' THEN
        ...
        IF L_QTTYTYPE = '2' THEN
            ...
            INSERT INTO SETRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields('03').value,'0088',p_txmsg.txfields('10').value,NULL,P_TXMSG.TXFIELDS('99').VALUE,p_txmsg.deltd,P_TXMSG.TXFIELDS('99').VALUE,seq_SETRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'');
        ...
        ELSE
            ...
            INSERT INTO SETRAN(TXNUM,TXDATE,ACCTNO,TXCD,NAMT,CAMT,ACCTREF,DELTD,REF,AUTOID,TLTXCD,BKDATE,TRDESC)
            VALUES (p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),p_txmsg.txfields('03').value,'0042',p_txmsg.txfields('10').value,NULL,P_TXMSG.TXFIELDS('99').VALUE,p_txmsg.deltd,P_TXMSG.TXFIELDS('99').VALUE,seq_SETRAN.NEXTVAL,p_txmsg.tltxcd,p_txmsg.busdate,'');
        ...
        UPDATE SEWITHDRAWDTL_TPRL SET DELTD = 'Y' WHERE AUTOID = TO_NUMBER(P_TXMSG.TXFIELDS('99').VALUE);
    END IF;
