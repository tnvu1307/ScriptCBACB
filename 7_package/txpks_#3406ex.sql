SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#3406ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#3406EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#3406ex
IS
   pkgctx   plog.log_ctx;
...
BEGIN
    ...
    ***************************************************************************************************/
    IF P_TXMSG.DELTD <> 'Y' THEN
        ...
        UPDATE CA040REGISTER SET DELTD = 'Y' WHERE AUTOID = L_AUTOID;
    END IF;
