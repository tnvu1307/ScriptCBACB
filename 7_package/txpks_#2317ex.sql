SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#2317ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#2317EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#2317ex
IS
   pkgctx   plog.log_ctx;
...
BEGIN
    ...
    ***************************************************************************************************/
    IF P_TXMSG.DELTD <> 'Y' THEN
        ...
        UPDATE SEMORTAGE_TPRL SET DELTD = 'Y' WHERE AUTOID = TO_NUMBER(P_TXMSG.TXFIELDS('99').VALUE);
    END IF;
