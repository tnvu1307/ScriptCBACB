SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#3387ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#3387EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#3387ex
IS
   pkgctx   plog.log_ctx;
...
BEGIN
    ...
    ***************************************************************************************************/
    IF p_txmsg.deltd <> 'Y' THEN
        ...
        nmpks_ems.pr_GenTemplateEM31(p_camastId => p_txmsg.txfields(c_camastid).value,
                                     p_custid   => l_custId,
                                     p_afacctno => p_txmsg.txfields('03').value);
    END IF;
