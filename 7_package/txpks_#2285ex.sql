SET DEFINE OFF;
CREATE OR REPLACE PACKAGE TXPKS_#2285EX
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#2285EX
...
CREATE OR REPLACE PACKAGE BODY TXPKS_#2285EX
IS
   pkgctx   plog.log_ctx;
   ...
   c_custodycd2       CONSTANT CHAR(2) := '07';
   c_acctno2          CONSTANT CHAR(2) := '11';
...
BEGIN
    ...
    ***************************************************************************************************/
    ...
    UPDATE APPENDIX_EX
      SET
         REAQTTY = REAQTTY + p_txmsg.txfields('13').value,
         REMAQTTY = AQTTY - (REAQTTY + p_txmsg.txfields('13').value)  where APPENDIXID=p_txmsg.txfields('02').value;
