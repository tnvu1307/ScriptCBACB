SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#3310ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#3310EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#3310ex
IS
   pkgctx   plog.log_ctx;
