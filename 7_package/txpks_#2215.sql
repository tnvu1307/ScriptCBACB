...
plog.setbeginsection (pkgctx, 'pr_txlog');
   ...
   plog.debug(pkgctx, 'abt to insert into tllogfld');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
      VALUES( seq_tllogfld.NEXTVAL, p_txmsg.txnum, TO_DATE(p_txmsg.txdate, systemnums.C_DATE_FORMAT),'18',0,p_txmsg.txfields('18').value,'Fee type');
   plog.debug(pkgctx, 'abt to insert into tllogfld');
   INSERT INTO tllogfld(AUTOID, TXNUM, TXDATE, FLDCD, NVALUE, CVALUE, TXDESC)
...
UPDATE TLLOG 
 SET DELTD = 'Y'
      ...
      SET 
           ...
           SYROOMLIMIT=p_txmsg.txfields('16').value,
           DFREFPRICE=p_txmsg.txfields('14').value,
           MARGINPRICE=p_txmsg.txfields('12').value,
           ROOMLIMITMAX=p_txmsg.txfields('15').value,
