SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#2318ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#2318EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#2318ex
IS
   pkgctx   plog.log_ctx;
...
BEGIN
    ...
    ***************************************************************************************************/
    IF P_TXMSG.DELTD <> 'Y' THEN
        ...
        CBBONDACB.CSPKS_VSTP.PRC_CALL_1511(L_DATA, p_err_code);
