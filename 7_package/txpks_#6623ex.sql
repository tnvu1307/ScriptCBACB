SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#6623ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6623EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#6623ex
IS
   pkgctx   plog.log_ctx;
    ...
    ***************************************************************************************************/
    select fn_getglobalid(p_txmsg.txdate, p_txmsg.txnum) into globalid_bank from dual;
        ...
        PCK_BANKAPI.Bank_UNholdbalance_No_Broker(
                  p_txmsg.txfields('95').value,  ---txnum cua giao dich hold
