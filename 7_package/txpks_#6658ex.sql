SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#6658ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#6658EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#6658ex
IS
   pkgctx   plog.log_ctx;
   ...
   c_custodycd        CONSTANT CHAR(2) := '44';
