SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#8805ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#8805EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#8805ex
IS
   pkgctx   plog.log_ctx;
   ...
   c_txdate           CONSTANT CHAR(2) := '23';
   c_broker           CONSTANT CHAR(2) := '24';
   c_ddacctno         CONSTANT CHAR(2) := '25';
